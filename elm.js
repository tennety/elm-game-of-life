...
var author$project$Cell$rpentomino = elm$core$Set$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(0, 0),
			_Utils_Tuple2(1, 0),
...
var author$project$GameOfLife$Model = F3(
	function (assetRoot, liveCells, state) {
		return {assetRoot: assetRoot, liveCells: liveCells, state: state};
	});
var author$project$GameOfLife$Paused = {$: 'Paused'};
var author$project$GameOfLife$initialModel = A3(author$project$GameOfLife$Model, '/', author$project$Cell$rpentomino, author$project$GameOfLife$Paused);
...
var author$project$Cell$wrap = function (_int) {
	return (_Utils_cmp(_int, -100) < 0) ? 100 : ((_int > 100) ? (-100) : _int);
};
var author$project$Cell$x = elm$core$Tuple$first;
var elm$core$Tuple$second = function (_n0) {
	var y = _n0.b;
	return y;
};
var author$project$Cell$y = elm$core$Tuple$second;
var author$project$Cell$neighbors = function (cell) {
	return elm$core$Set$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2(
				author$project$Cell$wrap(
					author$project$Cell$x(cell) - 1),
				author$project$Cell$wrap(
					author$project$Cell$y(cell) + 1)),
				_Utils_Tuple2(
				author$project$Cell$x(cell),
				author$project$Cell$wrap(
					author$project$Cell$y(cell) + 1)),
				_Utils_Tuple2(
				author$project$Cell$wrap(
...
var author$project$Cell$neighborhood = function (cells) {
	var filledHood = A3(
		elm$core$Set$foldl,
		A2(elm$core$Basics$composeL, elm$core$Set$union, author$project$Cell$neighbors),
		elm$core$Set$empty,
		cells);
...
var author$project$Cell$procreate = function (cells) {
	var familySize = function (cell) {
		return elm$core$Set$size(
			A2(
				elm$core$Set$intersect,
				author$project$Cell$neighbors(cell),
				cells));
	};
	...
	var willBeBorn = A2(
		elm$core$Set$filter,
		birthRule,
		author$project$Cell$neighborhood(cells));
	return A2(elm$core$Set$union, willSurvive, willBeBorn);
};
var author$project$GameOfLife$Running = {$: 'Running'};
var author$project$GameOfLife$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Reset':
				return _Utils_Tuple2(
					A3(author$project$GameOfLife$Model, model.assetRoot, author$project$Cell$rpentomino, author$project$GameOfLife$Paused),
					elm$core$Platform$Cmd$none);
			case 'Play':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{state: author$project$GameOfLife$Running}),
					elm$core$Platform$Cmd$none);
			case 'Pause':
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$GameOfLife$Reset = {$: 'Reset'};
...
var author$project$Cell$map = F2(
	function (f, cell) {
		return _Utils_Tuple2(
			author$project$Cell$x(
				A2(elm$core$Tuple$mapFirst, f, cell)),
			author$project$Cell$y(
				A2(elm$core$Tuple$mapSecond, f, cell)));
	});
...
var author$project$GameOfLife$cellForm = F4(
	function (radius, scale, translate, cell) {
		var scaled = author$project$Cell$map(
			function (coord) {
...
var author$project$GameOfLife$cellForms = function (liveCells) {
	return A2(
		...
		elm$core$Set$toList(liveCells));
};
var author$project$GameOfLife$Pause = {$: 'Pause'};
var author$project$GameOfLife$Play = {$: 'Play'};
...
var author$project$GameOfLife$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$image(model.assetRoot + 'images/retro-bg.jpg')
			]),
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$GameOfLife$playButton(model.state),
								...
								[
									...
									A2(
										...
										A3(
											...
											600,
											600,
											author$project$GameOfLife$cellForms(model.liveCells))))
								]))
						]))
				])));
};
