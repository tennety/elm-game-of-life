...
var author$project$GameOfLife$Model = F4(
	function (assetRoot, liveCells, state, fps) {
		return {assetRoot: assetRoot, fps: fps, liveCells: liveCells, state: state};
	});
var author$project$GameOfLife$Paused = {$: 'Paused'};
var author$project$GameOfLife$initialModel = A4(author$project$GameOfLife$Model, '/', author$project$Cell$rpentomino, author$project$GameOfLife$Paused, 0);
							...
							_List_fromArray(
								[
									...
									mdgriffith$elm_ui$Element$text(
										'fps:' + elm$core$String$fromInt(model.fps)))
								]))
						]))
				])));
};
